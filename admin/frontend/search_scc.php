...
$search = isset($_GET['search_scc']) ? trim($_GET['search_scc']) : '';
...
if (empty($search)) {
    ...
    $sqlCount = "SELECT COUNT(*) FROM report_fails WHERE operators LIKE :search";
                            ...
                            <div class="row g-2">
                                <div class="col-md-2">
                                    <input type="date" name="inspection_date" class="form-control"
                                        placeholder="Inspection Date" value="<?php echo $current_date; ?>"
                                        id="inspection_date">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <input type="number" name="burr" class="form-control" placeholder="Burr">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="blockend_hole" class="form-control"
                                        placeholder="Blockend Hole">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="non_flat_edge" class="form-control"
                                        placeholder="Non Flat Edge">
                                </div>
