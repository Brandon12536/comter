...
if (!isset($_SESSION['id_proveedor'])) {
    $_SESSION['error_message_sem52'] = "La sesión no tiene el id_proveedor.";
...
if ($id_molex === null) {
    $_SESSION['error_message_sem52'] = "ID de molex no proporcionado.";
    header("Location: molexsem52.php");
    exit();
}
...
if ($stmt->rowCount() > 0) {
    ...
    $_SESSION['error_message_sem52'] = "Molex no encontrada.";
    header("Location: molexsem52.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        $_SESSION['success_message_sem52'] = "Molex actualizada correctamente.";
        header("Location: molexsem52.php");
        exit();
    } else {
        $_SESSION['error_message_sem52'] = "Error al actualizar la Molex.";
        header("Location: molexsem52.php");
        exit();
    }
}
...
<head>
    ...
    <title>Editar Molex SEM52</title>
</head>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container my-5">
                        <h3 class="text-center mt-3">Editar MOLEX SEM52</h3>
                        <form action="editar_molex_sem52.php?id_molex=<?php echo $id_molex; ?>" method="post"
