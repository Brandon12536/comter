...
if (empty($search)) {
    ...
    $sqlCount = "SELECT COUNT(*) FROM inspection_data WHERE operators LIKE :search";
    $stmtCount = $con->prepare($sqlCount);
                            ...
                            <div class="row g-2">
                                <div class="col-md-2">
                                    <input type="date" name="inspection_date" class="form-control"
                                        placeholder="Inspection Date" required value="<?php echo $current_date; ?>"
                                        id="inspection_date">
                                </div>


                                <div class="col-md-2">
                                    <input type="text" name="operators" class="form-control" placeholder="Operators">
                                </div>
                                ...
                                <!-- Campos de 1er, 2do, 3er T -->
                                <div class="col-md-1">
                                    <input type="number" name="primer_t" class="form-control" placeholder="1er T">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="segundo_t" class="form-control" placeholder="2do T">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="tercer_t" class="form-control" placeholder="3er T">
                                </div>
                                <!-- Campo "Goods" como numérico -->
                                <div class="col-md-1">
                                    <input type="number" name="goods" class="form-control" placeholder="Goods">
                                </div>
                                <!-- Otros campos ya existentes -->
                                <div class="col-md-1">
                                    <input type="number" name="coupler" class="form-control" placeholder="Coupler">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="dano_end_face" class="form-control"
                                        placeholder="Dano End Face">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="golpe_top" class="form-control" placeholder="Golpe Top">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="rebaba" class="form-control" placeholder="Rebaba">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="dano_en_lente" class="form-control"
                                        placeholder="Dano en Lente">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="fuera_de_spc" class="form-control"
                                        placeholder="Fuera de SPC">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="dano_fisico" class="form-control"
                                        placeholder="Dano Fisico">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="coupler_dano" class="form-control"
                                        placeholder="Coupler Dañado">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="hundimiento" class="form-control"
                                        placeholder="Hundimiento">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="fisura" class="form-control" placeholder="Fisura">
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="silicon" class="form-control" placeholder="Silicon">
                                </div>
                                <div class="col-md-1">
                                ...
                                <!-- Campo "Comentarios" como textarea -->
                                <div class="col-md-12 mt-2">
                                    <textarea name="comments" class="form-control" placeholder="Comentarios"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-bordered" id="inspectionTable">
                                ...
                                <tbody>
                                    <?php if (empty($search)): ?>
                                        <tr>
                                            <td colspan="22" class="text-center">Por favor, ingrese un nombre para buscar.
                                            </td> <!-- Mensaje cuando el campo está vacío -->
                                        </tr>
