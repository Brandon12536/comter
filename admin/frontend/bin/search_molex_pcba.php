...
$sql = "SELECT nombre, apellido, compania, business_unit, telefono, correo, role, created_at, updated_at
        FROM proveedores 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmtInsert->bindParam(':shift', $shift, PDO::PARAM_INT);
    $stmtInsert->bindParam(':operators', $operators, PDO::PARAM_STR);
    $stmtInsert->bindParam(':goods', $goods, PDO::PARAM_INT);
    $stmtInsert->bindParam(':fails_dedos_oro', $fails_dedos_oro, PDO::PARAM_INT);
    $stmtInsert->bindParam(':fails_mal_corte', $fails_mal_corte, PDO::PARAM_INT);
    $stmtInsert->bindParam(':fails_contaminacion', $fails_contaminacion, PDO::PARAM_INT);
    $stmtInsert->bindParam(':pd', $pd, PDO::PARAM_INT);
    ...
    $stmtInsert->bindParam(':total', $total, PDO::PARAM_INT);
    $stmtInsert->bindParam(':yield', $yield, PDO::PARAM_STR); // Como porcentaje (con el símbolo '%')
    $stmtInsert->bindParam(':comments', $comments, PDO::PARAM_STR);
    $stmtInsert->bindParam(':user_id', $id_usuario, PDO::PARAM_INT);
...
$total_records_sql = "SELECT COUNT(*) FROM PCBA WHERE operators LIKE :search";
$total_records_stmt = $con->prepare($total_records_sql);
$total_records_stmt->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_select = "SELECT * FROM PCBA WHERE operators LIKE :search LIMIT :offset, :records_per_page";
$stmt_select = $con->prepare($sql_select);
$stmt_select->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_goods = "SELECT SUM(goods) AS total_goods FROM PCBA WHERE operators LIKE :search";
$stmt_sum_goods = $con->prepare($sql_sum_goods);
$stmt_sum_goods->bindParam(':search', $searchTerm, PDO::PARAM_STR);
$stmt_sum_goods->execute();
$row_sum_goods = $stmt_sum_goods->fetch(PDO::FETCH_ASSOC);
$total_goods = $row_sum_goods['total_goods'] ?? 0;


$sql_sum_fails_dedos_oro = "SELECT SUM(fails_dedos_oro) AS total_fails_dedos_oro FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_dedos_oro = $con->prepare($sql_sum_fails_dedos_oro);
$stmt_sum_fails_dedos_oro->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_fails_mal_corte = "SELECT SUM(fails_mal_corte) AS total_fails_mal_corte FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_mal_corte = $con->prepare($sql_sum_fails_mal_corte);
$stmt_sum_fails_mal_corte->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_fails_contaminacion = "SELECT SUM(fails_contaminacion) AS total_fails_contaminacion FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_contaminacion = $con->prepare($sql_sum_fails_contaminacion);
$stmt_sum_fails_contaminacion->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_pd = "SELECT SUM(pd) AS total_pd FROM PCBA WHERE operators LIKE :search";
$stmt_sum_pd = $con->prepare($sql_sum_pd);
$stmt_sum_pd->bindParam(':search', $searchTerm, PDO::PARAM_STR);
$stmt_sum_pd->execute();
$row_sum_pd = $stmt_sum_pd->fetch(PDO::FETCH_ASSOC);
$total_pd = $row_sum_pd['total_pd'] ?? 0;


$sql_sum_fails_desplazados = "SELECT SUM(fails_desplazados) AS total_fails_desplazados FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_desplazados = $con->prepare($sql_sum_fails_desplazados);
$stmt_sum_fails_desplazados->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_fails_insuficiencias = "SELECT SUM(fails_insuficiencias) AS total_fails_insuficiencias FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_insuficiencias = $con->prepare($sql_sum_fails_insuficiencias);
$stmt_sum_fails_insuficiencias->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_fails_despanelizados = "SELECT SUM(fails_despanelizados) AS total_fails_despanelizados FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_despanelizados = $con->prepare($sql_sum_fails_despanelizados);
$stmt_sum_fails_despanelizados->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_fails_desprendidos = "SELECT SUM(fails_desprendidos) AS total_fails_desprendidos FROM PCBA WHERE operators LIKE :search";
$stmt_sum_fails_desprendidos = $con->prepare($sql_sum_fails_desprendidos);
$stmt_sum_fails_desprendidos->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_total_fails = "SELECT SUM(total_fails) AS total_total_fails FROM PCBA WHERE operators LIKE :search";
$stmt_sum_total_fails = $con->prepare($sql_sum_total_fails);
$stmt_sum_total_fails->bindParam(':search', $searchTerm, PDO::PARAM_STR);
...
$sql_sum_total = "SELECT SUM(total) AS total_total FROM PCBA WHERE operators LIKE :search";
$stmt_sum_total = $con->prepare($sql_sum_total);
$stmt_sum_total->bindParam(':search', $searchTerm, PDO::PARAM_STR);
    ...
    <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container my-5">
                        ...
                        <div class="container">
                            <h3 class="text-center mt-3">Records</h3>
                                ...
                                <table class="table table-bordered text-center" id="inspectionTable"
                                    ...
                                    <thead style="background-color: #D9DAD9;">
                                        ...
                                        <tr>
                                            ...
                                            <th style="color:#000000; border-color: black;">DESCRIPTION</th>
                                            <th style="color:#000000; border-color: black;">SHIFT</th>
                                            <th style="color:#000000; border-color: black;">OPERATORS</th>
                                            <th style="color:#0fcb59; border-color: black;">GOODS</th>
                                            <th style="color:#000000; border-color: black;">DEDOS DE ORO CONTAMINADOS
                                            </th>
                                            <th style="color:#000000; border-color: black;">MAL CORTE</th>
                                            <th style="color:#000000; border-color: black;">CONTAMINACION</th>
                                            <th style="color:#000000; border-color: black;">PD</th>
                                            <th style="color:#000000; border-color: black;">DESPLAZADOS</th>
                                            <th style="color:#000000; border-color: black;">INSUFICIENCIAS</th>
                                            <th style="color:#000000; border-color: black;">DESPANELIZADOS</th>
                                            <th style="color:#000000; border-color: black;">DESPRENDIDOS</th>
                                            <th style="color:#000000; border-color: black;">TOTAL</th>
                                            <th style="color:#0fcb59; border-color: black;">TOTAL</th>
                                            <th style="color:#0fcb59; border-color: black;">YIELD</th>
                                            <th style="color:#000000; border-color: black;"><b>COMMENTS</b></th>
                                        </tr>
                                        <tr>
                                            <th colspan="4"
                                            ...
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_dedos_oro; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_mal_corte; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_contaminacion; ?></th>
                                            <th style="color:#000000; border-color: black;"><?php echo $total_pd; ?>
                                            </th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_desplazados; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_insuficiencias; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_despanelizados; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_fails_desprendidos; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $total_total_fails; ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo number_format($total_total); ?></th>
                                            <th style="color:#000000; border-color: black;">
                                                <?php echo $result_division . '%'; ?> </th>
                                    ...
                                    <tbody>
                                        <?php if (empty($search)): ?>
                                            <tr>
                                                <td colspan="22" class="text-center">Por favor, ingrese un nombre para
                                                    buscar.</td>
                                            </tr>
                                        <?php elseif (empty($records)): ?>
                                            <tr>
                                                <td colspan="22" class="text-center">No se encontraron resultados para la
                                                    búsqueda: "<?= htmlspecialchars($search) ?>"</td>
                                            </tr>
                                        <?php else: ?>
                                            <?php foreach ($records as $record): ?>
                                                <tr>
                                                    ...
                                                    <td style="border-color: black; color:#000000;">
                                                        <?= htmlspecialchars($record['description']) ?></td>
                                                    <td style="border-color: black; color:#000000;">
                                ...
                                <div class="pagination"
                                    ...
                                    <?php if ($current_page > 1): ?>
                                        <a href="?page=<?= $current_page - 1 ?>&search=<?= urlencode($search) ?>"
                                            class="btn btn-primary" style="margin-right: 5px;">Previous</a>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($current_page < $total_pages): ?>
                                        <a href="?page=<?= $current_page + 1 ?>&search=<?= urlencode($search) ?>"
                                            class="btn btn-primary" style="margin-right: 5px;">Next</a>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="molexpcba.php" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label for="fails_dedos_oro" class="form-label">DEDOS DE ORO
                                                    CONTAMINADOS</label>
                                                <input type="number" class="form-control" id="fails_dedos_oro"
                                                    name="fails_dedos_oro" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="fails_mal_corte" class="form-label">MAL CORTE</label>
                                                <input type="number" class="form-control" id="fails_mal_corte"
                                                    name="fails_mal_corte" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="fails_contaminacion"
                                                    class="form-label">CONTAMINACION</label>
                                                <input type="number" class="form-control" id="fails_contaminacion"
                                                    name="fails_contaminacion" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="pd" class="form-label">PD</label>
                                                <input type="number" class="form-control" id="pd" name="pd" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="fails_desplazados" class="form-label">DESPLAZADOS</label>
                                                <input type="number" class="form-control" id="fails_desplazados"
                                                    name="fails_desplazados" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="fails_insuficiencias"
                                                    class="form-label">INSUFICIENCIAS</label>
                                                <input type="number" class="form-control" id="fails_insuficiencias"
                                                    name="fails_insuficiencias" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="fails_despanelizados"
                                                    class="form-label">DESPANELIZADOS</label>
                                                <input type="number" class="form-control" id="fails_despanelizados"
                                                    name="fails_despanelizados" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="fails_desprendidos" class="form-label">DESPRENDIDOS</label>
                                                <input type="number" class="form-control" id="fails_desprendidos"
                                                    name="fails_desprendidos" value="0">
                                            </div>
                                            <div class="mb-3">
                                                <label for="total_fails" class="form-label">Total</label>
                                                <input type="number" class="form-control" id="total_fails"
                                                    name="total_fails">
                                            </div>
                                            <div class="mb-3">
        ...
        <script>
            ...
            function updateTotalInspectedAndYield() {
                ...
                const totalFails = parseFloat(document.getElementById('total_fails').value) || 0;
            ...
            document.getElementById('total_fails').addEventListener('input', updateTotalInspectedAndYield);
