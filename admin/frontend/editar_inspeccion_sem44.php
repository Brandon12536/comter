...
if (!isset($_SESSION['id_proveedor'])) {
    $_SESSION['error_message_sem44'] = "La sesión no tiene el id_proveedor.";
...
if ($id_inspeccion === null) {
    $_SESSION['error_message_sem44'] = "ID de inspección no proporcionado.";
    header("Location: molexsem44.php");
    exit();
}
...
if ($stmt->rowCount() > 0) {
    ...
    $_SESSION['error_message_sem44'] = "Inspección no encontrada.";
    header("Location: molexsem44.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        $_SESSION['success_message_sem44'] = "Inspección actualizada correctamente.";
        header("Location: molexsem44.php");
        exit();
    } else {
        $_SESSION['error_message_sem44'] = "Error al actualizar la inspección.";
        header("Location: molexsem44.php");
        exit();
    }
}
...
<head>
    ...
    <title>Editar Molex SEM44</title>
</head>
        ...
        <div data-i18n="Analytics">Nuevo Reporte</div>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <h3 class="text-center mt-3">Editar MOLEX SEM44</h3>
                        <form action="editar_inspeccion_sem44.php?id_inspeccion=<?php echo $id_inspeccion; ?>" method="post"
