...
if (!isset($_SESSION['id_proveedor'])) {
    $_SESSION['error_message_sem50'] = "La sesión no tiene el id_proveedor.";
...
if ($id_molex === null) {
    $_SESSION['error_message_sem50'] = "ID de molex no proporcionado.";
    header("Location: molexsem50.php");
    exit();
}
...
if ($stmt->rowCount() > 0) {
    ...
    $_SESSION['error_message_sem50'] = "Molex no encontrada.";
    header("Location: molexsem50.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        $_SESSION['success_message_sem50'] = "Molex actualizada correctamente.";
        header("Location: molexsem50.php");
        exit();
    } else {
        $_SESSION['error_message_sem50'] = "Error al actualizar la Molex.";
        header("Location: molexsem50.php");
        exit();
    }
}
...
<head>
    ...
    <title>Editar Molex SEM50</title>
</head>
        ...
        #layout-menu {
            ...
            height: auto;
                ...
                <div class="content-wrapper">
                    ...
                    <h3 class="text-center mt-3">Editar MOLEX SEM50</h3>
                        <form action="editar_molex_sem50.php?id_molex=<?php echo $id_molex; ?>" method="post"
