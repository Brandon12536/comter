...
if (!isset($_SESSION['id_proveedor'])) {
    $_SESSION['error_message_sem49'] = "La sesión no tiene el id_proveedor.";
...
if ($id_molex === null) {
    $_SESSION['error_message_sem49'] = "ID de molex no proporcionado.";
    header("Location: molexsem49.php");
    exit();
}
...
if ($stmt->rowCount() > 0) {
    ...
    $_SESSION['error_message_sem49'] = "Molex no encontrada.";
    header("Location: molexsem49.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        $_SESSION['success_message_sem49'] = "Molex actualizada correctamente.";
        header("Location: molexsem49.php");
        exit();
    } else {
        $_SESSION['error_message_sem49'] = "Error al actualizar la Molex.";
        header("Location: molexsem49.php");
        exit();
    }
}
...
<head>
    ...
    <title>Editar Molex SEM49</title>
</head>
        ...
        <div data-i18n="Analytics">Nuevo Reporte</div>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <h3 class="text-center mt-3">Editar MOLEX SEM49</h3>
                        <form action="editar_molex_sem49.php?id_molex=<?php echo $id_molex; ?>" method="post"
