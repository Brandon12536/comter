...
<body>
                    ...
                    <div class="header__nav__option">
                        <nav class="header__nav__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="../frontend/registro.php">Cliente</a></li>
                                <li><a href="../frontend/login_proveedor.php">Proveedor</a></li>
    ...
    <script>
        $(document).ready(function () {
            // Manejar el movimiento automático entre inputs
            ...
            $('#submit-verification').on('click', function (e) {
                ...
                var codigo_verificacion = $('#codigo_verificacion_1').val() +
                ...
                $.ajax({
                    type: 'POST',
                    url: '../backend/verify_administrador.php',
                    ...
                    success: function (response) {
                        ...
                        if (data.success) {
                            ...
                            window.location.href = '../Ui/administrador.php';
                        } else {

                            Swal.fire({
                                icon: 'error',
                                title: 'Código incorrecto',
                                text: 'El código que ingresaste no es válido. Por favor, intenta de nuevo.',
                            });
                        }
                    },
                    error: function () {
