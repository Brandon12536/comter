    ...
    <div class="content-wrapper">
        <div class="container my-5">
            ...
            <div class="container">
                ...
                <button id="resetFilters" class="btn btn-danger mb-3 d-none d-md-block"> <i class="fa fa-refresh"></i>
                    Reset Filters</button>



                <div class="table-responsive d-none d-md-block" style="max-height: 700px; overflow-y: auto;">
                                ...
                                <div id="filterCollapse" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="filter_date_mobile" type="text" class="form-control"
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                ...
                                                <p class="mb-2" data-description><?= htmlspecialchars($record['description']) ?>
                                                </p>
                                            </div>
                                            <div class="col-6">
                                                <strong>Turno:</strong>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_dedos_oro'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_mal_corte'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_contaminacion'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_desplazados'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_insuficiencias'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_despanelizados'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p
                                                        class="<?= $record['fails_desprendidos'] != 0 ? 'text-danger fw-bold' : '' ?>">
                                        ...
                                        <div class="mt-3 border-top pt-2">
                                            <div class="row g-2">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-primary fw-bold"><?= htmlspecialchars($record['total']) ?>
                                                    </p>
                                                </div>
                                                <div class="col-6">
                                                    <strong>Yield:</strong>
                                                    <p class="text-success fw-bold"><?= htmlspecialchars($record['yield']) ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
