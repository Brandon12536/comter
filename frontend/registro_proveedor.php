...
<body>
    ...
    <div class="form-container">
        <form id="registro-form" class="form" method="POST" action="../backend/registro.php">
            <p class="title"
            ...
            <p class="signin">¿Ya tienes una cuenta? <a href="login_proveedor.php">Iniciar sesión</a></p>
        </form>
    </div>
    ...
    <script>
        $('#registro-form').submit(function (e) {
            ...
            $.ajax({
                url: '../backend/registro_proveedor.php',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function (response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        window.location = 'verify_proveedor.php';
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
