...
$wirebond_corto_values = getUniqueValues('wirebond_corto', $con);
$wirebond_chueco_values = getUniqueValues('wirebond_chueco', $con);
                    ...
                    <table class="table table-bordered text-center" id="inspectionTable" style="border-color: black;">
                        <thead style="background-color: #D9DAD9; position: sticky; top: 0; z-index: 10;">
                            <tr>
                                ...
                                <th style="color:#000000; border-color: black;">WIREBOND CORTO
                                    <select id="filter_wirebond_corto" class="form-select form-select-sm mt-2">
                                        <option value="">All</option>
                                ...
                                <th style="color:#000000; border-color: black;">WIREBOND CHUECO
                                    <select id="filter_wirebond_chueco" class="form-select form-select-sm mt-2">
                                        <option value="">All</option>
                        ...
                        <tfoot style="background-color: #f2f2f2; position: sticky; bottom: 0; z-index: 10;">
                            <tr style="background-color: #f2f2f2;">
                                ...
                                <td style="border-color: black;"><?= number_format($total_golpe_top, 0) ?>
                                </td>
                                ...
                                <td style="border-color: black;"><?= number_format($total_dano_fisico, 0) ?>
                                </td>
                                <td style="border-color: black;">
                                ...
                                <td style="border-color: black;"><?= number_format($total_total_final, 0) ?>
                                </td>
