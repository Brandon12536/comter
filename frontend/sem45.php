...
function getUniqueValues($column, $con)
{
  ...
  if ($column === 'nombre_version') {
    $sql = "SELECT DISTINCT vi.nombre_version FROM inspecciones i
                JOIN versiones_inspeccion vi ON i.id_version = vi.id_version
                WHERE vi.nombre_version = 'sem45' AND vi.nombre_version IS NOT NULL AND vi.nombre_version != ''
                ORDER BY vi.nombre_version";
  } else {

    $sql = "SELECT DISTINCT i.$column FROM inspecciones i
                JOIN versiones_inspeccion vi ON i.id_version = vi.id_version
                WHERE vi.nombre_version = 'sem45' AND i.$column IS NOT NULL AND i.$column != ''
                ORDER BY i.$column";
  }
              ...
              <ul>
                ...
                <li>
                  <div class="d-flex align-items-center">
                    <span class="fw-semibold d-block ms-2" style="color:#fff; text-transform: uppercase;"><span
  ...
  <div class="content-wrapper">
    <div class="container my-5">
      ...
      <div class="container">
        ...
        <button id="resetFilters" class="btn btn-danger mb-3"> <i class="fa fa-refresh"></i> Reset Filters</button>
