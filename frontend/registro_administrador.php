...
<body>
    ...
    <div class="form-container">
        <form id="registro-form" class="form" method="POST" action="../backend/registro_administrador.php">
            <p class="title"
            ...
            <p class="message text-justify" style="text-align: justify;">Regístrate ahora y obtén acceso completo a
            ...
            <label for="compania">
                <input class="input" type="text" id="compania" name="compania" required="">
                <span>Compañía</span>
            </label>

            <label for="business_unit">
                <input class="input" type="text" id="business_unit" name="business_unit" required="">
            ...
            <label for="correo">
                <input class="input" type="email" id="correo" name="correo" required="" autocomplete="email">
            ...
            <p class="signin">¿Ya tienes una cuenta? <a href="admin.php">Iniciar sesión</a></p>
        </form>
    </div>
    ...
    <script>
        $('#registro-form').submit(function (e) {
            ...
            $.ajax({
    url: '../backend/registro_administrador.php',
    type: 'POST',
    data: formData,
    processData: false,
    contentType: false,
    ...
    success: function (response) {
        ...
        if (response.success) {
            ...
            window.location = 'verify_admin.php';
        } else {
            Swal.fire({
                icon: 'error',
                title: 'Error',
