...
function confirmarEliminacion(id_proveedor) {
    ...
    fetch(`backend/eliminar_registro.php?id_proveedor=${id_proveedor}`)
        ...
        .then(data => {
            ...
            let mensaje = '¿Quieres eliminar este registro?';
            if (data.warning) {
        ...
        .then((result) => {
            if (result.isConfirmed) {
                ...
                return fetch(`backend/eliminar_registro.php?id_proveedor=${id_proveedor}&confirmar=1`);
            }
