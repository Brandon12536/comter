                ...
                <div class="sidebar-menu">
                    <ul class="nav flex-column">
                        <li class="nav-item mt-1">
                            <button type="button" class="btn btn-primary w-100 nav-link" data-bs-toggle="modal" 
...
<li class="nav-item mt-1">
    <button class="btn btn-success w-100" onclick="mostrarSweetAlert()">
        <i class="fas fa-file-excel"></i> Exportar a Excel
    </button>
</li>
<li class="nav-item mt-1">
    <li class="nav-item mt-1">
    <form action="molex.php" method="POST" id="weekForm" onsubmit="return validateForm()" style="margin-bottom: 0;">
        ...
        <button type="submit" name="guardar_semana" class="btn btn-primary w-100" style="color: #fff;">Guardar Semana</button>
    </form>
    </li>
    <li class="nav-item mt-1">
            ...
            <div class="modal-body" style="background-color: rgba(255, 255, 255, 0.9);">
                <form id="formNuevoRegistro" method="POST" action="../administrador.php">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary w-100" onclick="sugerirContraseña()">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary w-100" onclick="cerrarModalNuevo()">Cancelar</button>
         ...
         <div class="modal-body">
             <form id="formNuevoRegistroCliente" method="POST" action="clientes.php">
                 <div class="row g-3">
                     ...
                     <div class="col-md-12">
                         <button type="button" class="btn btn-primary w-100" onclick="sugerirContraseñaCliente()">
                             <i class="fas fa-key"></i> Sugerir Contraseña
                         </button>
                     </div>
                 ...
                 <div class="modal-footer">
                     <button type="button" class="btn btn-secondary w-100" onclick="cerrarModalCliente()">Cancelar</button>
                     <button type="submit" class="btn btn-primary w-100" id="guardarBtnCliente" disabled>Guardar</button>
                 </div>
             </form>
         </div>
     </div>
